...
.SYNOPSIS
    ...
    Usage: irm https://geardung.github.io/zapret-updater/install.ps1 | iex
#>
...
if (-not $isAdmin) {
    ...
    $scriptUrl = "https://geardung.github.io/zapret-updater/install.ps1"
    $tempFile = Join-Path $env:TEMP "zapret-install.ps1"
...
$updaterPath = Join-Path $utilsDir "updater.ps1"
...
Write-Host "    irm https://geardung.github.io/zapret-updater/delete.ps1 | iex"
Write-Host ""
